...
>Функциональнность сайта: добавление новых карточек мест с собственными картинками, редактирование данных профиля, удаление карточек и возможность добавлять лайки к ним.
